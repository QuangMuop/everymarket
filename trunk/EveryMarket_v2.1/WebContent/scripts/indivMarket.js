						...
						indivMarketDwr.checkDangol($("#indivMarketWrapper").attr("owner_id"), function(dangol){
							if(dangol == 1){
								$("#bar_button_indivMarket_right").prepend(
									"<div id='button_deleteDangol' class='notOwnMarket b_s_button'><img id='b_m_s_button' src='image_blog_source/r_reg_btn.png'></div>"
//										"<div id='button_deleteDangol' class='b_s_button'><img id='b_m_s_button' src='image_blog_source/go_r_market.png'></div>"
								);							
							}else if(dangol == 0){
								$("#bar_button_indivMarket_right").prepend(
									"<div id='button_registerDangol' class='notOwnMarket b_s_button'><img id='b_m_s_button' src='image_blog_source/r_rev_btn.png'></div>"
