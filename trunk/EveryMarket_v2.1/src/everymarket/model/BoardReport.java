...
public class BoardReport {
	...
	/*
	 * public Timestamp getRep_checkTime() { return rep_checkTime; } public void
	 * setRep_checkTime(Timestamp rep_checkTime) { this.rep_checkTime =
	 * rep_checkTime; }
	 */

	/*
	 * @Override public String toString() { return "BoardReport [rep_id=" +
	 * rep_id + ", rep_reason=" + rep_reason + ", rep_writer=" + rep_writer +
	 * ", rep_content=" + rep_content + ", rep_regdate=" + rep_regdate +
	 * ", rep_productId=" + rep_productId + ", rep_memberId=" + rep_memberId +
	 * ", rep_check=" + rep_check + "]"; }
	 */
}
